Public Class Inicio
    ...
    Private Sub ButConsu_Click(sender As Object, e As EventArgs) Handles ButConsu.Click
        SQL = TxBConsu.Text
        If Trim(CBxConsu.Text) = String.Empty Then
            MessageBox.Show("Escoja tipo de instruccion SQL")
            CBxConsu.Focus()
        ElseIf Trim(TxBConsu.Text) = String.Empty Then
            MessageBox.Show("Escriba la instruccion SQL")
            TxBConsu.Focus()
        ElseIf CBxConsu.Text = "Consulta SELECT" Then
            ...
            End Select
        ElseIf CBxConsu.Text = "Consulta que no retorna" Then
            Select Case CBxProvi.Text
                Case "SQL Server"
                    SQLSOper(DGVDatos, SQL)

                Case "MySQL"
                    MSQLOper(DGVDatos, SQL)

                Case "SQLite"
                    SQLiOper(DGVDatos, SQL)
